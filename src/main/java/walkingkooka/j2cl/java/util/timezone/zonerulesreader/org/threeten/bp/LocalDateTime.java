...
//    }
    ...
    public static LocalDateTime ofEpochSecond(long epochSecond, int nanoOfSecond, ZoneOffset offset) {
        ...
        long localEpochDay = Jdk8Methods.floorDiv(localSecond, LocalTime.SECONDS_PER_DAY);
        int secsOfDay = Jdk8Methods.floorMod(localSecond, LocalTime.SECONDS_PER_DAY);
...
//    //-----------------------------------------------------------------------
    ...
    private LocalDateTime plusWithOverflow(LocalDate newDate, long hours, long minutes, long seconds, long nanos, int sign) {
        ...
        totDays += Jdk8Methods.floorDiv(totNanos, LocalTime.NANOS_PER_DAY);
        long newNoD = Jdk8Methods.floorMod(totNanos, LocalTime.NANOS_PER_DAY);
